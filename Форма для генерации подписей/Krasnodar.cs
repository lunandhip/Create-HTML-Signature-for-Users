...
namespace Форма_для_генерации_подписей
{
    ...
    class Krasnodar
    {
        ...
        {
            streamwriter = new StreamWriter(Place + NUserFIO + ".html");
            ...
            streamwriter.WriteLine($"        face=\"Arial\"><font color=\"#30b149\"><b>" + NUserFIO + "</b></font><br>" + "\t\t\t<!-- Имя и Фамилия -->"); // ФИО
            streamwriter.WriteLine($"        <font color=\"#333333\">"+ NUserPosition + ",<br>" + "\t\t\t\t\t<!-- Должность -->"); // Должность
            streamwriter.WriteLine("          2ГИС.Юг<br>");
            streamwriter.WriteLine("        </font></font><font size=\"-2\" face=\"Arial\"><font color=\"#333333\"><span");
            streamwriter.WriteLine("            style=\"color: rgb(51, 51, 51); font-family: Arial; ");
            streamwriter.WriteLine("            font-size: x-small; font-style: normal;");
            streamwriter.WriteLine("            font-variant-ligatures: normal; font-variant-caps: normal;");
            ...
            streamwriter.WriteLine("          size=\"-2\" face=\"Arial\" color=\"#333333\">350000, Краснодар,<br>");
            streamwriter.WriteLine("          Костылева, 13</font><br>");
            ...
            streamwriter.WriteLine("      normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width:");
            streamwriter.WriteLine("      0px; background-color: rgb(255, 255, 255); text-decoration-style:");
            streamwriter.WriteLine("      initial; text-decoration-color: initial;\"><font size=\"-1\"><span><font");
            streamwriter.WriteLine("            size=\"-2\" face=\"Arial\"><a");
            streamwriter.WriteLine("              href=\"http://info.2gis.ru/krasnodar/\"><span");
            streamwriter.WriteLine("                class=\"auto-style3\">info.2gis.ru/krasnodar</span></a></font><a");
            streamwriter.WriteLine("            href=\"http://info.2gis.ru/krasnodar/\"><span");
            streamwriter.WriteLine("              class=\"auto-style3\"></span></a></span></font></p>");
