    ...
    class Taganrog
    {
        ...
        public void Custom(string NUserFIO, string NUserNomerVn, string NUserMT, string Place, string NUserPosition)
        {
            ...
            if (NUserMT != "88000000000")                                                                            // Указываем мобильный. Если тру
                streamwriter.WriteLine("          " + NUserMT + "\t\t\t\t\t\t\t\t\t\t\t<!-- Моб.Номер -->");
            else
            ...
            streamwriter.WriteLine("          size=\"-2\" face=\"Arial\" color=\"#333333\">347905, Таганрог,<br>");
            streamwriter.WriteLine("          Социалистическая, 2, 2 этаж</font><br>");
            streamwriter.WriteLine("      </font></p>");
            streamwriter.WriteLine("    <p><font size=\"-1\"><span><font size=\"-2\" face=\"Arial\"><a");
            streamwriter.WriteLine("              href=\"http://info.2gis.ru/taganrog/ \"><span");
            streamwriter.WriteLine("                class=\"auto-style3\">info.2gis.ru/taganrog</span></a><br>");
