...
namespace Форма_для_генерации_подписей
{
    class Armavir
    {
        ...
        public void Custom(string NUserFIO, string NUserNomerVn, string NUserMT, string Place, string NUserPosition)
        {
            ...
            streamwriter.WriteLine("        face=\"Arial\"><font color=\"#30b149\"><b>" + NUserFIO + "</b></font><br>" + "\t\t\t<!-- Имя и Фамилия -->");
            ...
            streamwriter.WriteLine("          size=\"-2\" face=\"Arial\" color=\"#333333\">352900, Армавир,<br>");
            streamwriter.WriteLine("          Энгельса, 59/1, 3 этаж</font><br>");
            ...
            streamwriter.WriteLine("            face=\"Arial\"><a href=\"http://info.2gis.ru/armavir/\"><span\"");
            streamwriter.WriteLine("                class=\"auto-style3\">info.2gis.ru/armavir</span></a></font><a");
            streamwriter.WriteLine("            href=\"http://info.2gis.ru/armavir/\"><span");
